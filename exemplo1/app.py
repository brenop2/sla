...
def create_app():
    ...
    app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://root:@localhost:3306/ra3"
    app.config["SQLALCHEMY_TRACK_MODIFICATIONS"] = False
    db.init_app(app)

    # Registra os blueprints para sensores e atuadores
    ...
    @app.route("/")
    def home():
        return render_template("home.html")  # Certifique-se de que o arquivo 'home.html' existe
...
if __name__ == "__main__":
    app = create_app()
    create_db(app)  # Cria o banco de dados se necessário
    app.run(host="0.0.0.0", port=8080, debug=True)
